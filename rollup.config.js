...
const standaloneBaseConfig = {
  ...
  input: './src/index.js',
  output: {
    file: 'dist/react-native-hooks-share.js',
    format: 'umd',
    globals,
    name: 'react-native-hooks-share',
    sourcemap: true,
  },
...
const standaloneProdConfig = {
  ...
  output: {
    ...
    file: 'dist/react-native-hooks-share.min.js',
  },
...
const nativeConfig = {
  ...
  output: [
    getCJS({
      file: 'dist/react-native-hooks-share.cjs.js',
    }),
    getESM({
      file: 'dist/react-native-hooks-share.esm.js',
    }),
  ],
};
